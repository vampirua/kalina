...
namespace app\modules\statusproduct;
...
class Module extends BaseModule implements IAdminModule, BootstrapInterface
{
     ...
     */
    protected $_classMap = [
        'StatusProduct' => 'app\modules\statusproduct\models\StatusProduct',
    ];
    ...
    public function bootstrap($app)
    {
        ...
        if ($app instanceof WebApplication) {
            if (!isset($app->i18n->translations['statusproduct*'])) {
                $app->i18n->translations['statusproduct*'] = [
